...
import co.tinode.tinsdk.model.TrustedType;
...
public class Topic<DP, DR, SP, SR> implements LocalData, Comparable<Topic> {
    private static final String TAG = "co.tinode.tinsdk.Topic";
