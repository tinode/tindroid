...
import co.tinode.tinsdk.model.AuthScheme;
import co.tinode.tinsdk.model.ClientMessage;
import co.tinode.tinsdk.model.Credential;
import co.tinode.tinsdk.model.Description;
import co.tinode.tinsdk.model.MetaSetDesc;
import co.tinode.tinsdk.model.MsgClientAcc;
import co.tinode.tinsdk.model.MsgClientDel;
import co.tinode.tinsdk.model.MsgClientExtra;
import co.tinode.tinsdk.model.MsgClientGet;
import co.tinode.tinsdk.model.MsgClientHi;
import co.tinode.tinsdk.model.MsgClientLeave;
import co.tinode.tinsdk.model.MsgClientLogin;
import co.tinode.tinsdk.model.MsgClientNote;
import co.tinode.tinsdk.model.MsgClientPub;
import co.tinode.tinsdk.model.MsgClientSet;
import co.tinode.tinsdk.model.MsgClientSub;
import co.tinode.tinsdk.model.MsgGetMeta;
import co.tinode.tinsdk.model.MsgRange;
import co.tinode.tinsdk.model.MsgServerCtrl;
import co.tinode.tinsdk.model.MsgServerData;
import co.tinode.tinsdk.model.MsgServerInfo;
import co.tinode.tinsdk.model.MsgServerMeta;
import co.tinode.tinsdk.model.MsgServerPres;
import co.tinode.tinsdk.model.MsgSetMeta;
import co.tinode.tinsdk.model.Pair;
