...
import com.example.testapp.common.utils.Utils
...
import com.example.testapp.components.channel.list.header.viewmodel.ChannelListHeaderViewModel
import com.example.testapp.components.channel.list.header.viewmodel.bindView
...
import com.example.testapp.components.common.extensions.internal.findListener
import com.example.testapp.databinding.TinuiFragmentChannelListBinding
import com.example.testapp.components.search.SearchInputView
import com.example.testapp.components.search.list.SearchResultListView
import com.example.testapp.components.search.list.viewmodel.SearchViewModel
import com.example.testapp.components.search.list.viewmodel.bindView
...
public open class ChannelListFragment : Fragment() {
    ...
    private var _binding: TinuiFragmentChannelListBinding? = null
    protected val binding: TinuiFragmentChannelListBinding get() = _binding!!
    ...
    override fun onCreateView(
        ...
        return TinuiFragmentChannelListBinding.inflate(layoutInflater, container, false)
            .apply { _binding = this }
            .root
    }
