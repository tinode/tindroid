package com.example.testapp.components.message.list.background
 ...
 */
public open class MessageBackgroundFactoryImpl(private val style: MessageListItemStyle) :
    ...
    private fun defaultBackground(context: Context, data: MessageListItem.MessageItem): Drawable {
        ...
        return MaterialShapeDrawable(shapeAppearanceModel).apply {
            val hasLink = false //data.message.attachments.any(Attachment::hasLink)
            if (data.isMine) {
    ...
    public companion object {
        private val MESSAGE_OTHER_USER_BACKGROUND = R.color.tinui_white
        private val MESSAGE_CURRENT_USER_BACKGROUND = R.color.tinui_grey_gainsboro
    ...
    private fun shapeAppearanceModel(
        ...
        return ShapeAppearanceModelFactory.create(
            context,
            radius,
            bottomEndCorner,
            isMine,
