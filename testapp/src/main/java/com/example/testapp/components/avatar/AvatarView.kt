...
import com.example.testapp.common.images.load
...
public class AvatarView : AppCompatImageView {
    ...
    private fun avatarShape(style: AvatarStyle): TinuiImageLoader.ImageTransformation {
        return when (style.avatarShape) {
            AvatarShape.CIRCLE -> TinuiImageLoader.ImageTransformation.Circle
            AvatarShape.SQUARE -> TinuiImageLoader.ImageTransformation.RoundedCorners(style.borderRadius)
        }
    }
