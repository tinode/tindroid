...
import com.example.testapp.components.channel.list.internal.SimpleChannelListView
...
public class ChannelListView public @JvmOverloads constructor(
    context: Context,
    ...
    private var errorEventHandler = ErrorEventHandler { errorEvent ->
        when (errorEvent) {
            is ChannelListViewModel.ErrorEvent.HideChannelError -> "R.string.tinui_channel_list_error_hide_channel"
            is ChannelListViewModel.ErrorEvent.DeleteChannelError -> "R.string.tinui_channel_list_error_delete_channel"
            is ChannelListViewModel.ErrorEvent.LeaveChannelError -> "R.string.tinui_channel_list_error_leave_channel"
        }.let(::showToast)
    }
