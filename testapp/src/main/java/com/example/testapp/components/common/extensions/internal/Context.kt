...
internal fun Context.createStreamThemeWrapper(): Context {
    ...
    return when {
        theme.resolveAttribute(R.attr.tinui_ValidTheme, typedValue, true) -> this
        theme.resolveAttribute(R.attr.tinui_Theme, typedValue, true) -> ContextThemeWrapper(this, typedValue.resourceId)
        else -> ContextThemeWrapper(this, R.style.tinui_Theme)
    }
}
