...
import com.example.testapp.common.utils.extensions.activity
import com.example.testapp.common.utils.extensions.isDirectMessaging
import com.example.testapp.common.utils.extensions.showToast
import com.example.testapp.common.view.EndlessScrollListener
...
import com.example.testapp.components.common.extensions.internal.getFragmentManager
...
import com.example.testapp.components.message.list.adapter.MessageListListenerContainerImpl
import com.example.testapp.components.message.list.adapter.viewholder.MessageListItemViewHolderFactory
import com.example.testapp.components.message.list.adapter.internal.MessageListItemAdapter
import com.example.testapp.components.message.list.adapter.viewholder.MessageListItemDecoratorProvider
import com.example.testapp.components.message.list.background.MessageBackgroundFactory
import com.example.testapp.components.message.list.background.MessageBackgroundFactoryImpl
import com.example.testapp.components.message.list.internal.HiddenMessageListItemPredicate
import com.example.testapp.components.message.list.internal.MessageListScrollHelper
import com.example.testapp.components.message.list.model.MessageListItemWrapper
...
import com.example.testapp.databinding.TinuiMessageListViewBinding
...
public class MessageListView : ConstraintLayout {
    ...
    private lateinit var binding: TinuiMessageListViewBinding
...
//    }
    ...
    private var confirmDeleteMessageHandler = ConfirmDeleteMessageHandler { _, confirmCallback ->
        AlertDialog.Builder(context)
            .setTitle(R.string.tinui_message_list_delete_confirmation_title)
            .setMessage(R.string.tinui_message_list_delete_confirmation_message)
            .setPositiveButton(R.string.tinui_message_list_delete_confirmation_positive_button) { dialog, _ ->
                dialog.dismiss()
                confirmCallback()
            }
            .setNegativeButton(R.string.tinui_message_list_delete_confirmation_negative_button) { dialog, _ ->
                dialog.dismiss()
            }
            .show()
    }
    ...
    private var confirmFlagMessageHandler = ConfirmFlagMessageHandler { _, confirmCallback ->
        AlertDialog.Builder(context)
            .setTitle(R.string.tinui_message_list_flag_confirmation_title)
            .setMessage(R.string.tinui_message_list_flag_confirmation_message)
            .setPositiveButton(R.string.tinui_message_list_flag_confirmation_positive_button) { dialog, _ ->
                dialog.dismiss()
                confirmCallback()
            }
            .setNegativeButton(R.string.tinui_message_list_flag_confirmation_negative_button) { dialog, _ ->
                dialog.dismiss()
            }
            .show()
    }
...
//    }
    ...
    private var errorEventHandler = ErrorEventHandler { errorEvent ->
        when (errorEvent) {
            is MessageListViewModel.ErrorEvent.MuteUserError -> R.string.tinui_message_list_error_mute_user
            is MessageListViewModel.ErrorEvent.UnmuteUserError -> R.string.tinui_message_list_error_unmute_user
            is MessageListViewModel.ErrorEvent.BlockUserError -> R.string.tinui_message_list_error_block_user
            is MessageListViewModel.ErrorEvent.FlagMessageError -> R.string.tinui_message_list_error_flag_message
            is MessageListViewModel.ErrorEvent.PinMessageError -> R.string.tinui_message_list_error_pin_message
            is MessageListViewModel.ErrorEvent.UnpinMessageError -> R.string.tinui_message_list_error_unpin_message
        }.let(::showToast)
    }
...
//                Toast.makeText(
//                    context,
//                    context.getString(R.string.tinui_message_list_download_started),
//                    Toast.LENGTH_SHORT
//                ).show()
...
//    private lateinit var attachmentFactoryManager: AttachmentFactoryManager
    ...
    private fun init(attr: AttributeSet?) {
        binding = TinuiMessageListViewBinding.inflate(streamThemeInflater, this)
...
//        buffer.active()
    ...
    private fun configureAttributes(attributeSet: AttributeSet?) {
        context.obtainStyledAttributes(
            ...
            tArray.getInteger(
                R.styleable.MessageListView_tinui_LoadMoreThreshold,
                LOAD_MORE_THRESHOLD,
...
//        }
        ...
        messageListItemViewHolderFactory.decoratorProvider = MessageListItemDecoratorProvider(
            ...
            isCurrentUserBanned = { /*channel.isCurrentUserBanned()*/ false },
        )
...
//                    buffer.active()
    ...
    private fun chatMessageStart(messageStartValue: Int) {
        messageStartValue
            .let(MessagesStart.Companion::parseValue)
