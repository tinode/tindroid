...
import com.example.testapp.databinding.TinuiSearchResultListViewBinding
import com.example.testapp.components.search.internal.SearchResultListAdapter
...
public class SearchResultListView : ViewFlipper {
    ...
    private val binding = TinuiSearchResultListViewBinding.inflate(streamThemeInflater, this)
        ...
        binding.searchListView.apply {
            ...
            addItemDecoration(
                DividerItemDecoration(
                    ...
                    setDrawable(AppCompatResources.getDrawable(context, R.drawable.tinui_divider)!!)
                }
            )
    ...
    public fun showMessages(query: String, messages: List<Message>) {
        ...
        if (!isEmpty) {
            binding.searchInfoBar.text =
                resources.getQuantityString(R.plurals.tinui_search_results_count, messages.size, messages.size)
        } else {
            binding.emptyLabel.text = context.getString(R.string.tinui_search_results_empty, query)
        }
    ...
    public fun showError() {
        Toast.makeText(context, R.string.tinui_search_results_error, Toast.LENGTH_SHORT).show()
    }
