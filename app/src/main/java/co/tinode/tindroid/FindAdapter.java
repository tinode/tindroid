...
public class FindAdapter extends RecyclerView.Adapter<FindAdapter.ViewHolder>
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == R.layout.tindroid_not_found ||
                viewType == R.layout.tindroid_no_permission ||
                viewType == R.layout.tindroid_no_search_query) {
            return new ViewHolderEmpty(view);
        } else if (viewType == R.layout.tindroid_contact_section) {
    ...
    public int getItemViewType(int position) {
        if (position == 0) {
            return R.layout.tindroid_contact_section;
        }
        ...
        if (count == 0) {
            if (position == 0) {
                ...
                return mPermissionGranted ? R.layout.tindroid_not_found : R.layout.tindroid_no_permission;
            }
            // One 'empty' element
            count = 1;
        } else if (position < count) {
            return R.layout.tindroid_contact;
        }
        ...
        if (count == 0 && position == 0) {
            return TextUtils.isEmpty(mSearchTerm) ? R.layout.tindroid_no_search_query : R.layout.tindroid_not_found;
        }
