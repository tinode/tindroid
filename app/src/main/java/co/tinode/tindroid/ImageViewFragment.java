...
import co.tinode.tinui.widgets.OverlaidImageView;
...
public class ImageViewFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.tindroid_fragment_view_image, container, false);
        mMatrix = new Matrix();
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.tindroid_menu_image, menu);
    }
    ...
    private void acceptAvatar() {
        ...
        if (cutOut.width() < ImageUtils.MIN_AVATAR_SIZE || cutOut.height() < ImageUtils.MIN_AVATAR_SIZE) {
            // Avatar is too small.
