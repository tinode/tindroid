        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            if (senderId != null) {
                ...
                if (sender == null) {
                    ...
                    Cache.backgroundMetaFetch(this, senderId);
            ...
            if (TextUtils.isEmpty(what) || "msg".equals(what)) {
                ...
                if (seqStr != null) {
                    ...
                    if (!Cache.backgroundDataFetch(getApplicationContext(), topicName, Integer.parseInt(seqStr))) {
                ...
                Cache.backgroundMetaFetch(getApplicationContext(), topicName);
