...
public class AccPersonalFragment extends Fragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.tindroid_fragment_acc_personal, container, false);
        ...
        if (me != null) {
            ...
            if (creds != null) {
                for (Credential cred : creds) {
                    View container = inflater.inflate(R.layout.tindroid_credential, credList, false);
            ...
            if (tags != null) {
                for (String tag : tags) {
                    TextView label = (TextView) inflater.inflate(R.layout.tindroid_tag, tagsView, false);
                    label.setText(tag);
    ...
    private void showEditTags() {
        ...
        final View editor = LayoutInflater.from(builder.getContext()).inflate(R.layout.tindroid_dialog_edit_tags, null);
    ...
    private void showConfirmCredential(final String meth, final String val) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(activity);
        final View editor = LayoutInflater.from(builder.getContext()).inflate(R.layout.tindroid_dialog_validate, null);
    ...
    private void showAddCredential() {
        ...
        final View editor = LayoutInflater.from(activity).inflate(R.layout.tindroid_dialog_add_credential, null);
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        inflater.inflate(R.menu.tindroid_menu_save, menu);
