...
import co.tinode.tinui.db.StoredSubscription;
import co.tinode.tinui.media.VxCard;
import co.tinode.tinui.widgets.HorizontalListDivider;
...
public class TopicInfoFragment extends Fragment implements MessageActivity.DataSetChangeListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.tindroid_fragment_topic_info, container, false);
    }
    ...
    private void showMemberAction(final String topicTitle, final String userTitle, final String uid,
        ...
        final LinearLayout actions = (LinearLayout) View.inflate(activity, R.layout.tindroid_dialog_member_actions, null);
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.tindroid_menu_edit, menu);
    ...
    private class MembersAdapter extends RecyclerView.Adapter<MemberViewHolder> {
        ...
        public MemberViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            // create a new view
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.tindroid_group_member, parent, false);
