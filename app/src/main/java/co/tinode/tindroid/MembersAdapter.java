...
public class MembersAdapter extends RecyclerView.Adapter<MembersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        if (holder.viewType == R.layout.tindroid_group_member_chip) {
    ...
    public int getItemViewType(int position) {
        if (getActualItemCount() == 0) {
            return R.layout.tindroid_group_member_chip_empty;
        }
        return R.layout.tindroid_group_member_chip;
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(@NonNull View itemView, int viewType) {
            ...
            if (viewType == R.layout.tindroid_group_member_chip) {
