...
import co.tinode.tinui.account.ContactsObserver;
    ...
    public void onCreate() {
        ...
        try {
            ...
            if (TextUtils.isEmpty(sAppVersion)) {
                sAppVersion = co.tinode.tinui.BuildConfig.VERSION_NAME;
            }
            sAppBuild = pi.versionCode;
            if (sAppBuild <= 0) {
                sAppBuild = co.tinode.tinui.BuildConfig.VERSION_CODE;
            }
