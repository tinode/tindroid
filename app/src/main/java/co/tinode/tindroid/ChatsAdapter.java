...
import co.tinode.tinui.format.PreviewFormatter;
...
public class ChatsAdapter extends RecyclerView.Adapter<ChatsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        if (holder.viewType == R.layout.tindroid_contact) {
    ...
    public int getItemViewType(int position) {
        if (getActualItemCount() == 0) {
            return R.layout.tindroid_contact_empty;
        }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(@NonNull View item, ClickListener cl, int viewType) {
            ...
            if (viewType == R.layout.tindroid_contact) {
